...
import static io.raulprojects.tinder_AI_BKND.Utils.generateMyersBriggsTypes;
import static io.raulprojects.tinder_AI_BKND.Utils.selfieTypes;
import static io.raulprojects.tinder_AI_BKND.Utils.generateMyersBriggsTypes;
import static io.raulprojects.tinder_AI_BKND.Utils.selfieTypes;
...
import io.raulprojects.tinder_AI_BKND.repositories.ProfileRepo;
import io.raulprojects.tinder_AI_BKND.supplement.OllamaOptions;
...
public class ProfileCreationService {
    ...
    private OllamaChatClient chatClient2;
    ...
    public ProfileCreationService(OllamaChatClient chatClient, ProfileRepo profileRepository) {
        this.chatClient2 = chatClient;
    ...
    public void createProfiles(int numberOfProfiles) {
        ...
        while (this.generatedProfiles.size() < numberOfProfiles) {
            ...
            ChatResponse response = chatClient2.call(new Prompt(prompt,
